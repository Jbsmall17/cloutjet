...
export default function BuyerAccount({social,country,flag,price,desc,profilePic,userName}: {social:string,country: string, flag?: string, price: string,desc: string,profilePic: string,userName: string }){
        return (
            <div className='mb-4 rounded-lg border border-[#17223b] py-1.5 md:py-2.5 px-2 md:px-4 flex flex-row items-center gap-4 md:gap-6 lg:gap-8'>
                <div>
                    <img 
                        src={social}
                ...
                <div className='flex-1'>
                    ...
                    <p className='text-base hidden md:block w-[70%] mb-1'>{desc}</p>
