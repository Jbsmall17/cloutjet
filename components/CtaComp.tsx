  ...
  return (
    <section className="py-6 md:py-8 lg:py-10 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 lg:gap-8 xl:gap-10">
      ...
      <div className='flex-1'>
        ...
        <Link href="/signup">
        <button className='rounded-md py-4 px-6 text-white dark:text-white bg-[#17223b] text-xl hover:opacity-80 active:opacity-80 transition transition-opacity cursor-pointer'>
