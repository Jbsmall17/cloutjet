          ...
          <section className="bg-[#17233b] text-white pb-8 md:pb-10 lg:pb-14 lg:pb-16">
            <div className="text-black max-w-screen-2xl px-[5%] 2xl:px-0 mx-auto flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-12">
              <div className="relative p-4 md:p-6 pb-8 md:pb-10 flex-1 bg-white rounded-lg border-[#f8a11e] border-2">
                ...
                <Button
                  onClick={()=>setStage(1)}
                  className="block mx-auto bg-[#f8a11e] text-black hover-opacity-80 cursor-ponter"
                  size={"lg"}
                >
                  Start growing
                </Button>
          ...
          <section className="pt-4 md:pt-6 lg:pt-0 bg-white max-w-screen-2xl px-[5%] flex flex-col lg:flex-row items-center justify-between gap-10 md:gap-16 lg:gap-8">
            <div className="space-y-6">
              ...
              <p className="hidden lg:block text-xl font-normal">
                Your brand deserves the spotlight —<br /> boost visibility,
                trust and traffic with
                <br /> real engagement
              </p>
              <p className="text-center block lg:hidden text-xl font-normal">
                Your brand deserves the spotlight —boost visibility, trust and traffic with real engagement
              </p>
            </div>
              ...
              <div className="mx-auto flex flex-row gap-6 min-h-[175px] max-w-[800px]">
                <div className="relative py-4 pr-4 pl-8 lg:pl-14 bg-white rounded-lg">
                  ...
                  <p className="text-sm font-semibold">
                    I really enjoy using the services of clout jet cause my
                    online presence has grown and is still growing at a rapid
                    rate. All thanks to the real engagement I paid for. it was
                    worth the service
                  </p>
                  <img
          ...
          <section className="bg-white rounded-xl flex flex-col sm:flex-row">
            ...
            <div className="pt-6 pb-8 px-3 lg:px-6 flex-1 w-full">
              ...
              <div className="sm:max-w-[400px] lg:max-w-[600px] mx-auto">
                ...
                <div>
                  <div className=" mb-6 cursor-pointer group border border-gray-500 hover:border-black rounded-lg flex flex-row gap-4 p-3 items-center transition-all duration-300 ease-linear">
                    <div className="size-2 group-hover:size-4 rounded-full ring-3 group-hover:ring-4 ring-[#8a8a8a] group-hover:ring-black group-hover:bg-[#f8a11e] transition-all duration-300 ease-linear"></div>
                    <div>
                      <p className="text-[#919191] group-hover:text-black text-base font-semibold transition-all duration-300 ease-linear">
                        Bot Engagements
                      </p>
                      <p className="text-base text-[#8a8a8a] group-hover:text-black transition-all duration-300 ease-linear">
                        Fast, cost effective results. May not be sustainable
                      </p>
                    </div>
                  </div>
                  <div className="mb-10 cursor-pointer group border border-gray-500 hover:border-black rounded-lg flex flex-row gap-4 p-3 items-center transition-all duration-300 ease-linear">
                    <div className="size-2 group-hover:size-4 rounded-full ring-3 group-hover:ring-4 ring-[#8a8a8a] group-hover:ring-black group-hover:bg-[#f8a11e] transition-all duration-300 ease-linear"></div>
                    <div>
                      <p className="text-[#919191] group-hover:text-black text-base font-semibold transition-all duration-300 ease-linear">
                        Real Engagements
        ...
        <section className="bg-[#17233b] max-w-screen-2xl px-[5%]  py-10 md:py-12 lg:py-16">
          <div className="bg-white max-w-screen-md mx-auto rounded-lg py-6 px-4 sm:px-8 md:px-12 lg:px-16">
            ...
            <div className="px-2 sm:py-4 px-2 sm:px-4 md:px-6 lg:px-10 text-sm sm:text-base font-semibold flex flex-col sm:flex-row justify-between sm:items-center text-black">
              ...
              <p className="text-[#a99e8e]">https://instagram.com/uykadugu/hieqi/likes%20</p>
            </div>
            <div className="py-4 px-4 md:px-6 lg:px-10 flex flex-row items-center">
              <Checkbox className="inline mr-4 size-6" />
              <span className="text-base text-black">
                I agree with the <span className="text-[#1877f2]">Terms and Conditions</span>
              </span>
            </div>
            <Button className="block px-14 h-12 mb-3 mx-auto mt-4 md:mt-6 lg:mt-8 bg-[#f8a11e] text-black">Confirm order</Button>
            <p className="text-center font-semibold">Track your order in Dashboard</p>
          </div>
        </section>
      )}
      <Footer />
