...
export default function Page() {
  ...
  const getAListedAccount = () => {
    ...
    axios
      ...
      .then((res) => {
        const {  account, paymentSummary } = res.data.data;
        setListedAccount({
  ...
  return step === 0 ? (
            ...
            <CardHeader>
              <div className="flex flex-col md:flex-row sm:items-start gap-4 md:gap-6">
                ...
                <div className="space-y-2 flex-1">
                  <CardTitle className="text-xl font-semibold">
                    <Link
                      target="_blank"
                      href={listedAccount.account.profileLink}
                    >
                  ...
                  <CardDescription className="text-sm text-black font-medium">
                    <p>
                      Niche | {listedAccount.account.niche || "N/A"} |{" "}
                      {Number(listedAccount.account.accountAge) == 1
                        ? `${listedAccount.account.accountAge} year`
                        : `${listedAccount.account.accountAge} years`}
                    </p>
                  </CardDescription>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <div className="text-center flex-1 space-y-1">
                      <p className="text-xl font-medium">
                        ...
                        listedAccount.account.followersCount !== 0
                    ...
                    <div className="flex-1 text-center">
                      <p className="text-xl font-medium">
                        {formatPriceToNaira(
                          listedAccount.account.preferredPrice
                        )}
                      </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 mt-4">
                ...
                <Badge variant="secondary" className="py-1.5">
                  ...
                  listedAccount.account.engagementRate !== 0
              ...
              <div className="w-full sm:w-[300px] md:w-[400px] lg:w-[500px] border-2 border-[#f8a11e] rounded-xl flex justify-center items-center">
                {listedAccount.account.proofScreenshotUrl ? (
                  <Image
                    ...
                    alt="screenshot"
                    className="rounded-xl min-h-[300px] h-full w-full object-cover"
                    width={400}
                    height={400}
                  />
                ) : (
    ...
    <div className="relative">
      ...
      <p className="text-xl font-medium mb-4 md:mb-6 lg:mb-8 text-center">
        Confirm Purchase
      </p>
        ...
        <CardContent>
            ...
            <div className="space-y-3">
              <div className="text-[#8a8a8a] text-base flex flex-row justify-between items-center">
                ...
                <p className="capitalize">
                  {listedAccount.account.platform || "N/A"}
                </p>
              </div>
              <div className="text-[#8a8a8a] text-base flex flex-row justify-between items-center">
                <p>Username</p>
              ...
              <div className="text-[#8a8a8a] text-base flex flex-row justify-between items-center">
                <p>seller</p>
                <p>{listedAccount.account.seller?.fullName || ""}</p>
              </div>
            </div>
          </div>
          <div className="px-5 py-3 rounded-lg mb-3 md:mb-5 border border-[#f8a11e]">
            ...
            <p className="text-base text-black">
              This fee covers secure escrow processing and seller verification
            </p>
          </div>
        </CardContent>
